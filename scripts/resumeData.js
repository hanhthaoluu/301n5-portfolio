...
var educationData = [
  {
    schoolImage: '<img id="uw" src="images/uw-college-of-arts-sciences-logo_0.jpg" alt="UW logo">',
    school: '<em>University of Washington</em>',
    location: 'Seattle WA',
    degreeCertificate: '<p>Bachelor of Science in Microbiology<br /> Bachelor of Arts in Psychology</p>'
  },
  {
    schoolImage: '<img id="codeFellows" src="images/hi-res-code-fellows-logo-2.png" alt="CodeFellows logo">',
    school: '<em>Code Fellows</em>',
    location: 'Seattle WA',
    degreeCertificate: 'Programming Certificate in progress'
  },
];

var resumeData = [
  {
    title: '<em>Vietnamese Medical Interpreter and Translator</em>',
  ...
  {
    title: '<em>Vietnamese Interpreter and Translator</em>',
  ...
  {
    title: '<em>Vietnamese Translator</em>',
  ...
  {
    title: '<em>Laboratory Technician</em>',
